  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="px-4 space-y-4 animate-fade-in">
        <div className="clay-card-primary p-6 text-center">
        ...
        <div>
          ...
          <div className="space-y-2">
            {BADGES.map((badge, i) => (
              ...
              >
                <div className={`w-10 h-10 rounded-2xl flex items-center justify-center ${badge.earned ? "bg-primary text-primary-foreground shadow-clay" : "bg-muted"}`}>
