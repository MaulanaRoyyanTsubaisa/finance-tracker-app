      ...
      <div className="w-full max-w-sm space-y-6 animate-fade-in">
        ...
        {!isForgot && (
          <>
            <button
              ...
              disabled={loading}
              className="w-full py-3 clay-card font-bold text-sm flex items-center justify-center gap-2 transition-shadow disabled:opacity-50"
            >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 clay-btn text-base disabled:opacity-50"
          >
